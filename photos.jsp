					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse" id="profile-opts-navbar">
							<ul class="nav navbar-nav navbar-right">
								...
								<li class="active"><a href="#"><i class="fa fa-file-image-o"></i>Photos</a></li>
							</ul>
						</div>
					</div>
				</div>
          ...
          <!-- content -->
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="panel panel-default panel-list-photos">
            	...
            	for(Image img :imgs){            		
            		if(i%3==1){
                		div1 +="<div class='photo-content'><img src='img/"+img.getLocation()+"/"+img.getName()+"' class='img-responsive img-rounded  show-in-modal'></div>";
            		}
            		if(i%3==2){
                    	div2 +="<div class='photo-content'><img src='img/"+img.getLocation()+"/"+img.getName()+"' class='img-responsive img-rounded  show-in-modal'></div>";
               		}
            		if(i%3==0){
                    	div3 +="<div class='photo-content'><img src='img/"+img.getLocation()+"/"+img.getName()+"' class='img-responsive img-rounded  show-in-modal'></div>";
               		}
            		i++;
